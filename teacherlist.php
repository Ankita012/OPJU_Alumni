	...
	<div class="row" id="r1">
        <div class= "col-lg-2 sidebar" id="c1">
			...
			<ul class="list-group">
				...
				<li class="list-group-item"><a href="alumnilist.php">alumnilist.php</a></li>
				<li class="list-group-item active"><a href="#j1">Teacher List</a></li>
				<li class="list-group-item "><a href="invite.php">Invite Alumni</a></li>
			</ul>
		</div>
		<div class="col-lg-10" id="c2">
			<div class="jumbotron" id="j1">
			   <h2>Teacher list</h2><hr><br>
			   <?php
					    include_once("config.php");$count=0;
						$result = mysqli_query($mysqli, "SELECT * FROM teacher WHERE 1");
